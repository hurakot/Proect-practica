...
В данном задании была выбрана тема практической реализации технологии создания ботов. В данной работе будет создан телеграмм-бот, код которого будет написан на python. Данный бот должен будет считать количество отправляемых картинок в минуту от пользователей и в случае превышения лимита он будет отправлять уведомления нарушителям.
